"""This module is part of an old attempt to manage the lyrics database as a collection of tarballs. It is not used anymore, but has some useful code dealing with tarballs."""
# std lib
import argparse
